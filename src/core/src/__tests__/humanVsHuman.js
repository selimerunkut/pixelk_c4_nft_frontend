...
describe('PlayerHuman vs PlayerHuman', function () {
    var players = [
    ...
    test('Basic test', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    board = new BoardBase();
                    game = new TestGame(players, board);
                    game.start();
                    expect(board.map).toMatchSnapshot();
                    return [4, players[0].doAction(3)];
                case 1:
                    _a.sent();
                    return [4, game.afterMovePromise];
                case 2:
                    _a.sent();
                    expect(board.map).toMatchSnapshot();
                    return [4, players[1].doAction(3)];
                case 3:
                    _a.sent();
                    return [4, game.afterMovePromise];
                case 4:
    ...
    test('Cannot move on a filled column', function () { return __awaiter(void 0, void 0, void 0, function () {
        var board, game, currentMap;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    board = new BoardBase();
...
//# sourceMappingURL=humanVsHuman.js.map